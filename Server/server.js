...
const allowedOrigins = ["https://skillbridge-henna.vercel.app"]; // the port at which your frontend is running on.
...
app.use(
  cors({ origin: allowedOrigins, credentials: true, method: ["POST", "GET"] })
);
